...
/**
 * Only method changed in this class is the kill() method.
...
public class Player implements GameItemConsumer {
	...
	public void apValue(){
		this.listener.apRemaining(this.ap);
	}
	...
	/**
	 *	Sends change to listener
	 */
	public void sendChange() {
		this.listener.sendChange();
	}
	 ...
	 *
	 * This method has to be edited to remove players from the map when the die.
	 * Hence why the location is set to -1, -1. This was a bug with the original code
	 * given to us and has been confirmed by Nicholas Westlake.
	 */
	public void kill() {
		this.hp = 0;
